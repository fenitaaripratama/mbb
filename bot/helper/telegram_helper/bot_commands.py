...
class _BotCommands:
    def __init__(self):
        self.StartCommand = getCommand(f'START_COMMAND', f'start222{CMD_INDEX}')
        ...
        self.HelpCommand = getCommand('HELP_COMMAND', f'help222{CMD_INDEX}')
        ...
        self.WatchCommand =  getCommand('WATCH_COMMAND', f'watch222{CMD_INDEX}')
        self.ZipWatchCommand = getCommand('ZIPWATCH_COMMAND', f'zipwatch222{CMD_INDEX}')
        self.ScrapeCommand = getCommand('SCRAPE_COMMAND', f'scrape{CMD_INDEX}')
        self.QbMirrorCommand = getCommand('QBMIRROR_COMMAND', f'qbmirror222{CMD_INDEX}')
        self.QbUnzipMirrorCommand = getCommand('QBUNZIP_COMMAND', f'qbunzipmirror222{CMD_INDEX}')
        self.QbZipMirrorCommand = getCommand('QBZIP_COMMAND', f'qbzipmirror222{CMD_INDEX}')
        ...
        self.LeechCommand = getCommand('LEECH_COMMAND', f'leech222{CMD_INDEX}')
        self.UnzipLeechCommand = getCommand('UNZIPLEECH_COMMAND', f'unzipleech222{CMD_INDEX}')
        self.ZipLeechCommand = getCommand('ZIPLEECH_COMMAND', f'zipleech222{CMD_INDEX}')
        self.QbLeechCommand = getCommand('QBLEECH_COMMAND', f'qbleech222{CMD_INDEX}')
        self.QbUnzipLeechCommand = getCommand('QBZIPLEECH_COMMAND', f'qbunzipleech222{CMD_INDEX}')
        self.QbZipLeechCommand = getCommand('QBUNZIPLEECH_COMMAND', f'qbzipleech222{CMD_INDEX}')
        self.LeechWatchCommand = getCommand('LEECHWATCH_COMMAND',  f'leechwatch222{CMD_INDEX}')
        ...
        self.LeechZipWatchCommand = getCommand('LEECHZIPWATCH_COMMAND', f'leechzipwatch222{CMD_INDEX}')
